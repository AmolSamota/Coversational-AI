                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-3 flex-1">
                            ...
                            <p className="text-sm text-blue-800">
                              All plans saved from the <strong>Scenario Modeling</strong> tab will be listed here. You can view, modify, publish, or download your saved plans. Plans can be saved as drafts for further refinement or published to execute the workforce transformation strategy.
                            </p>
                          </div>
                        </div>
                      </div>
